...
const ExerciseCard: React.FC<ExerciseCardProps> = ({ exercise, onUpdateWeight, onViewProgress, onEdit, onImageClick, darkMode }) => {
  return (
      ...
      <div className="flex gap-4 items-start">
        {exercise.image ? (
          <img 
            src={exercise.image} 
            alt={exercise.name} 
            className="w-20 h-20 rounded-xl object-cover bg-gray-100 cursor-pointer hover:opacity-80 transition-opacity active:scale-95" 
